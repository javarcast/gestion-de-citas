  ...
  <table>
    ...
    <tr v-for="appointment in appointments" :key="appointment.id">
      ...
      <td class="px-4 py-2 border">
        <Link :href="route('citas.show', appointment.id)"> <i class="far fa-eye text-green-600"></i> </Link>
      </td>
      <td class="px-4 py-2 border">
        <Link :href="route('citas.edit', appointment.id)"> <i class="fas fa-edit text-blue-600"></i> </Link>
      </td>
      <td class="px-4 py-2 border">
        <a href="#" @click.prevent="destroy(appointment.id)"> <i class="fas fa-trash-alt text-red-600"></i></a>
      </td>
    </tr>
    </tbody>
  </table>
